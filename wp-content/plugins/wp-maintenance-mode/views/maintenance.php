<?php $settings = $this->get_plugin_settings(); ?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <div class="maintenance">
			<div>
				<div class="maintenance__logo">
					<img src="<?php echo $settings['design']['bg_custom']?>">
				</div>
				<?php if (!empty($heading)) { ?><h1 class="maintenance__title"><?php echo stripslashes($heading); ?></h1><?php } ?>
				<?php if (!empty($text)) { ?><h2 class="maintenance__text"><?php echo stripslashes($text); ?></h2><?php } ?>
			</div>
			<div class="maintenance__img">
				<img src="/wp-content/plugins/wp-maintenance-mode/assets/images/maintenance.png">
			</div>
			<?php
