...
$context['labels'] = json_encode([
    'your_city' => __('Your city','BranderMap'),
    ...
    'lombards_near_you' => __('Lombards near you','BranderMap'),
    'more_info' => __('More info','BranderMap'),
    'from_you' => __('from you','BranderMap'),
    'km' => __('km','BranderMap'),
    ...
    foreach ($context['mapData'] as $department) {
        if (isset($department->post_meta) && !empty($department->post_meta['department_group'])) {
            ...
            if ($departmentGroup['lat'] !='' && $departmentGroup['lng'] !='') {
                ...
                #block start
                /**
                 * TODO: Add the necessary attributes to the object
                 */
                ...
                {
                    $departmentData[$i]['regions_cities'] = $department->regions_cities;
                }
                #block end
            }
        }
...
$pageView->display('advanced-map.twig', $context);
return ob_get_clean();
