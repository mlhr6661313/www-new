...
class Config
{
     ...
     */
    const SCRIPTS_PATH = '/wp-content/plugins/BranderMap/public/js';

    /**
     *  Style directory const
     */
    const STYLES_PATH = '/wp-content/plugins/BranderMap/public/css';

    /**
     *  Languages path const
     */
    const LANGUAGES_PATH  = 'BranderMap/lang';
