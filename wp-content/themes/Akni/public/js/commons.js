...
"use strict";
/* unused harmony export getAjaxParams */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return toArray; });
/* unused harmony export hasSelector */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return check; });
/* unused harmony export createElement */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return each; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return baseObj; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vendors_jquery__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vendors_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__vendors_jquery__);
...
var baseObj = {
    ...
    fixBody: function fixBody(elem, action) {
        if (action === false) {
            __WEBPACK_IMPORTED_MODULE_0__vendors_jquery___default()('html, body').css('overflow', 'visible');
            elem.css('overflow', 'hidden');
        } else {
            __WEBPACK_IMPORTED_MODULE_0__vendors_jquery___default()('html, body').css('overflow', 'hidden');
    ...
    ajaxAction: function ajaxAction(formData, succesData) {
        __WEBPACK_IMPORTED_MODULE_0__vendors_jquery___default.a.ajax({
            type: 'POST',
            url: this.ajax_url,
            data: formData,
            success: function success(_success) {
                succesData(_success);
                __WEBPACK_IMPORTED_MODULE_0__vendors_jquery___default()('.products_list_block .products_list').show().parent().find('.products_list_loader').remove();
            },
    ...
    var $ = function () {
        ...
        _createClass($, [{
            ...
            value: function _config() {
                ...
                var tabSlide = true;
                var maxScreen = 650;
                var navWrapper = '.smarty-controller';
                var navList = navWrapper + '__list';
                var navItems = navWrapper + '__item';
                var contentWrapper = '.smarty-content';
                var contentItems = contentWrapper + '__item';
                var activeClass = {
            ...
            value: function _eventFunc() {
                 ...
                 */
                var initCustomChange = new CustomEvent('change.custom', {
                    bubbles: true,
                    cancelable: true
                });
                ...
                var _that$_config = that._config(),
                    navList = _that$_config.navList,
                    contentItems = _that$_config.contentItems,
                    activeClass = _that$_config.activeClass;

                var contentElem = $._el(contentItems, true);
                var navListElem = $._el(navList);

                var activeControllerIndex = that._config().startIndex;
                ...
                function windowResize() {
                    if (that._checkScreen()) that._tabPosition();
                }
                ...
                function customChange(callback) {
                    return function (event) {
                        var activeController = event.target;
                        var activeContent = contentElem[activeControllerIndex];
                 ...
                 */
                return this.config.functions ? this.config.functions : this.config.functions = {
                    /**
                     ...
                     */
                    initCustomChange: function initCustomChange(callback) {
                        !that.config.hasOwnProperty('customChange') ? that.config.customChange = customChange(callback) : that.config.customChange;
                     ...
                     */
                    destroyController: function destroyController() {
                     ...
                     */
                    destroyCustomChange: function destroyCustomChange() {
            ...
            key: '_checkScreen',
            value: function _checkScreen() {
                var _config2 = this._config(),
                    tabSlide = _config2.tabSlide,
                    maxScreen = _config2.maxScreen,
                    navList = _config2.navList,
                    navWrapper = _config2.navWrapper;

                var navListWidth = $._el(navList).offsetWidth;
                var navWrapperWidth = $._el(navWrapper).offsetWidth;

                return tabSlide && navListWidth > navWrapperWidth || tabSlide && maxScreen >= navWrapperWidth;
            }
            ...
            key: '_tabPosition',
            value: function _tabPosition(el) {
                var _config3 = this._config(),
                    navList = _config3.navList,
                    navWrapper = _config3.navWrapper;

                var navListElem = $._el(navList, false);
                var navWrapperElem = $._el(navWrapper, false);

                var positionX = el ? navWrapperElem.offsetWidth / 2 - el.offsetWidth / 2 - el.offsetLeft : 0;
                var offsetRight = navWrapperElem.scrollWidth - navWrapperElem.clientWidth;
            ...
            value: function _removeActiveClass() {
                var _config4 = this._config(),
                    navItems = _config4.navItems,
                    contentItems = _config4.contentItems,
                    activeClass = _config4.activeClass;
                ...
                $._each(itemsCollection, function (items) {
                    $._each(items.elem, function (elem) {
            ...
            key: '_startTab',
            value: function _startTab() {
                var _config5 = this._config(),
                    navItems = _config5.navItems,
                    contentItems = _config5.contentItems,
                    activeClass = _config5.activeClass,
                    startIndex = _config5.startIndex;

                var navItem = $._el(navItems, true);
                var contentItem = $._el(contentItems, true)[startIndex];
            ...
            key: '_targetTabIndex',
            value: function _targetTabIndex(el) {
                var navList = Array.prototype.slice.call($._el(this._config().navItems, true));
            ...
            key: 'init',
            value: function init() {
                var _eventFunc2 = this._eventFunc(),
                    initController = _eventFunc2.initController,
                    initResize = _eventFunc2.initResize;
            ...
            value: function change(callback) {
                var _eventFunc3 = this._eventFunc(),
                    initCustomChange = _eventFunc3.initCustomChange;
            ...
            value: function destroy() {
                var _eventFunc4 = this._eventFunc(),
                    destroyController = _eventFunc4.destroyController,
                    destroyResize = _eventFunc4.destroyResize,
                    destroyCustomChange = _eventFunc4.destroyCustomChange;
            ...
            key: '_isExistClass',
            value: function _isExistClass(className) {
            ...
            key: '_el',
            value: function _el(single, collection) {
            ...
            key: '_each',
            value: function _each(array, callback) {
 ...
 */
/* harmony default export */ __webpack_exports__["a"] = (function (init, parameters) {
